...
app.put('/api/settings', requireAuth, (req, res) => {
  ...
  const allowed = [
    ...
    'orangeMerchant', 'orangeMerchantName', 'mpesaMerchant', 'mpesaMerchantName', 'mtnMerchant', 'mtnMerchantName', 'airtelMerchant', 'airtelMerchantName',
    'ussdOrangeCode', 'ussdMpesaCode', 'ussdMtnCode', 'ussdAirtelCode',
    'ussdOrangeMarchand', 'ussdMpesaMarchand', 'ussdMtnMarchand', 'ussdAirtelMarchand',
