(function () {
  ...
  let settings = {
    siteName: 'ISTC News',
    siteFullName: 'Institut Supérieur de Techniques Commerciales',
    tagline: 'L'actualité de l\'ISTC en direct',
    primaryColor: '#c8102e',
    secondaryColor: '#f5c518',
    textColor: '#16222e',
    backgroundColor: '#f6f8fb',
    headerBackground: '#ffffff',
    headerTextColor: '#16222e',
    footerBackground: '#0d1f14',
    footerTextColor: '#d7e3da',
    defaultTheme: 'light',
    enableDarkMode: true,
    heroTitle: 'L\'actualité de l\'ISTC en direct',
    heroText: 'Découvrez les dernières actualités, événements et réussites de l\'Institut Supérieur de Techniques Commerciales.',
    registrationTitle: 'Inscriptions à distance',
    registrationText: 'Inscrivez-vous à distance en quelques minutes. Paiement en ligne sécurisé.',
    registrationDeadline: '2024-12-20',
    registrationOpen: true,
    contactEmail: 'contact@istc.edu',
    contactPhone: '+242 55 55 55',
    contactAddress: 'ISTC, Boulevard de la Technologie, Brazzaville',
    logoImage: '',
    favicon: '',
    metaDescription: 'Actualités et informations de l\'Institut Supérieur de Techniques Commerciales',
    metaKeywords: 'ISTC, actualités, inscriptions, commerce, techniques',
    ogImage: '',
    googleAnalyticsId: '',
    customCss: ''
  };
  ...
  let allArticles = [
    {
      id: 1,
      title: 'Nouvelle session d\'admissions lancées',
      category: 'Annonce',
      content: 'Les inscriptions pour la nouvelle session académique 2024-2025 sont désormais ouvertes. Rejoignez nos programmes de commerce, gestion et communication.',
      author: 'ISTC Admin',
      date: '2024-09-15',
      featured: true,
      published: true,
    ...
    {
      id: 2,
      title: 'Forum de l\'emploi ISTC 2024',
      category: 'Événement',
      content: 'Participez au forum de l\'emploi qui se tiendra le 25 septembre 2024. Rencontrez nos partenaires entreprises et découvrez les opportunités de stage.',
      author: 'Carrière ISTC',
      date: '2024-09-10',
      featured: false,
      published: true,
      image: ''
    ...
    {
      id: 3,
      title: 'Témoignage d\'un ancien élève',
      category: 'Vie étudiante',
      content: 'Marie-Claire, diplômée 2022, partage son expérience sur son parcours professionnel et ses conseils pour les étudiants actuels.',
    ...
    {
      id: 4,
      title: 'Bourses d\'excellence disponibles',
      category: 'Annonce',
      content: 'Plusieurs bourses d\'excellence sont disponibles pour les étudiants brillants. Critères et modalités de candidature sur notre site.',
      author: 'ISTC Admin',
      date: '2024-08-28',
      featured: true,
      published: true,
    ...
    },
    {
      ...
      category: 'Événement',
      content: ' Venez découvrir nos installations, rencontrer nos enseignants et poser toutes vos questions sur nos formations le 15 octobre 2024.',
      author: 'Admissions ISTC',
      date: '2024-08-20',
      featured: false,
      published: true,
      image: ''
